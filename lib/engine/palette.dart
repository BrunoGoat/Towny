...
class Palette {
  ...
  static const _night = _PaletteSpec(
    ...
    ground: Color(0xFF131622),
    groundFar: Color(0xFF242C43),
  ...
  static const _dawn = _PaletteSpec(
    ...
    ground: Color(0xFF393832),
    groundFar: Color(0xFF756757),
  ...
  static const _morning = _PaletteSpec(
    ...
    ground: Color(0xFF52563C),
    groundFar: Color(0xFF838869),
  ...
  static const _day = _PaletteSpec(
    ...
    ground: Color(0xFF51553E),
    groundFar: Color(0xFF828868),
  ...
  static const _golden = _PaletteSpec(
    ...
    ground: Color(0xFF4E4A2F),
    groundFar: Color(0xFF8B7A55),
  ...
  static const _dusk = _PaletteSpec(
    ...
    ground: Color(0xFF383429),
    groundFar: Color(0xFF735C47),
  ...
  static const _twilight = _PaletteSpec(
    ...
    ground: Color(0xFF20202C),
    groundFar: Color(0xFF443F57),
