...
List<Solid> solidsOf(
  ...
  switch (piece.kind) {
    ...
    case PieceKind.porch:
      // Lo que queda de la palabra «porche» ahora que la puerta se fue: la
      // tarima de un soportal, el embarcadero de una barca, la visera sobre un
      // portal. Cinco sitios, y los cinco son un cuerpo que se pisa o que
      // aguanta la lluvia, o sea piedra.
      //
      // Iban encalados, del mismo color que la fachada de la que salen, y por
      // eso se leían igual que se leía la puerta: como un cubo blanco pegado
      // encima.
      return [
